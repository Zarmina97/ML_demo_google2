...
<h2>Observations</h2>
    <ul>
        ...
        <li><strong>Male customers</strong> have a higher purchase volume and also contribute to a greater financial expenditure overall.</li>
            <figure><img src="res/data exploration/gender_n_purchases.png" width=500, height=300></figure>
            <figure><img src="res/data exploration/gender_avg_purchases.png" width=500, height=300></figure>
